...
test('ParseError(message, fileName)', (t) => {
  ...
  t.throws(() => { new ParseError('', 'file.js') }, Error, `[10] Throws Error when 1st argument is given an empty string`)
  t.throws(() => { new ParseError('message') }, TypeError, `[11] Throws TypeError when 2nd argument not given`)
