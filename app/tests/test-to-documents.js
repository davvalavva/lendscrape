...
test('tableToDocs({ rows, labelMap })', (t) => {
  ...
  t.throws(() => { tableToDocs(data) }, TypeError, `[22] Throws TypeError when property 'labelMap' in object passed to function is an array of objects, but not all objects have a property 'field'`)
